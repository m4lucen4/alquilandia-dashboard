...
export type CreateInventoryFormValues = z.infer<typeof inventorySchema>;

interface ModalCreateInventoryProps {
  isOpen: boolean;
  isCreating: boolean;
...
export const ModalCreateInventory: FC<ModalCreateInventoryProps> = ({
  isOpen,
  isCreating,
  categoryOptions,
  onClose,
  ...
  const toNumber = (e: React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement>) =>
    Number.parseFloat((e as React.ChangeEvent<HTMLInputElement>).target.value) || 0;
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div
        ...
        role="dialog"
        aria-labelledby="modal-create-inventory-title"
      >
        <button
          type="button"
          onClick={onClose}
        ...
        <form onSubmit={handleSubmit(onSubmit)} noValidate>
          <div className="p-6 sm:p-8">
            <h3
              id="modal-create-inventory-title"
              ...
              <Controller
                ...
                render={({ field }) => (
                  <InputField
                    ...
                    placeholder="Ej. CASTILLO HINCHABLE"
                  />
                )}
              />
